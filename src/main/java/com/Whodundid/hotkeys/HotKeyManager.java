...
import com.Whodundid.hotkeys.hotKeyGuis.HotKeyCreationStepByStep;
import com.Whodundid.hotkeys.hotKeyGuis.HotKeyCreatorGui;
import com.Whodundid.hotkeys.hotKeyGuis.HotKeyGuiMain;
import com.Whodundid.hotkeys.hotKeyGuis.HotKeyListGui;
import com.Whodundid.hotkeys.hotKeyGuis.RegisteredKeyVisualGui;
...
public class HotKeyManager extends SubMod {
	...
	static boolean runCreationTutorial = true;
	...
	public boolean registerHotKey(HotKey keyIn) {
		synchronized (registeredHotKeys) {
			if (!doesListAlreadyContain(keyIn, registeredHotKeys)) {
				...
				System.out.println("EnhancedMC: Registered hotkey: " + keyIn.getKeyName());
			}
			if (keyIn.isBuiltIn()) {

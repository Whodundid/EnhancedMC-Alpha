...
public class CommandHotKey extends HotKey {
	...
	public CommandHotKey setCommand(String commandIn) { command = commandIn; return this; }
	
	@Override public void executeHotKeyAction() { if (mc.thePlayer != null) { mc.thePlayer.sendChatMessage(command); } }

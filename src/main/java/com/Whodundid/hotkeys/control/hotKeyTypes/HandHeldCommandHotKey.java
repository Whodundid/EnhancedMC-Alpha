...
public class HandHeldCommandHotKey extends HotKey {
	...
	public HandHeldCommandHotKey setCommand(String commandIn) { command = commandIn; return this; }
	public HandHeldCommandHotKey setItemID(int idIn) { itemID = idIn; return this; }

...
public class RegisteredSubMods {
	...
	public static boolean registerSubMod(SubMod modIn) {
		if (!isModRegistered(modIn)) { return registeredMods.add(modIn); }
		return false;
	}
	...
	public static boolean isModRegistered(SubMod modIn) { return isModRegistered(modIn.getModType()); }
	public static boolean isModRegistered(SubModType typeIn) {
		for (SubMod m : registeredMods) {
			if (m.getModType().equals(typeIn)) { return true; }
		}
		return false;
	}

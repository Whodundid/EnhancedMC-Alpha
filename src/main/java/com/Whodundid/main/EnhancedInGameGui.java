...
public class EnhancedInGameGui extends ModdedInGameGui implements IEnhancedTopParent {
	...
	public void drawObject(int mXIn, int mYIn, float ticks) {
		...
		//System.out.println("obj: " + getHighestZObjectUnderMouse());
		GlStateManager.pushMatrix();
		...
		try {
			if (!underMouse.isEmpty()) {
				...
				for (int i = 0; i < underMouse.size(); i++) {
					IEnhancedGuiObject o = underMouse.get(i);
					//System.out.print(highestZObj + ", ");
					if (highestZObj != null) {
						//System.out.print((o.getZLevel() + " :: " + highestZObj.getZLevel()) + " ");

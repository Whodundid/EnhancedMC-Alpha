...
public class ModdedInGameGui extends GuiIngame {
    ...
    protected void renderJumpBar(int width, int height) {
        ...
        if (filled > 0) { drawTexturedModalRect(x, top, 0, 89, filled, 5); }
            ...
            if (remainingHighlightTicks > 0 && highlightingItemStack != null) {
                ...
                if (opacity > 0) {
                    ...
                    if (font != null) {
                        ...
                        drawStringWithShadow(name, x, y, 0xffffff | (opacity << 24));
                    }
                    GlStateManager.disableBlend();
    ...
    protected void renderRecordOverlay(int width, int height, float partialTicks) {
        if (recordPlayingUpFor > 0) {
            ...
            if (opacity > 0) {
                ...
                drawString(recordPlaying, -fontRenderer.getStringWidth(recordPlaying) / 2, -4, color | (opacity << 24));
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
